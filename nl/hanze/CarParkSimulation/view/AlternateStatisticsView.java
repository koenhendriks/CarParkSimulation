...
public class AlternateStatisticsView extends AbstractView
{
    ...
    public void updateView() {
        ...
        bar1.setString((carPark.getTotalCars()-carPark.getTotalPassholderIndex()-carPark.getTotalReservationIndex()) + " " +
                Language.get("regbar") +
                percent1 + "%");
        ...
        bar2.setString(carPark.getTotalPassholderIndex() +  " " +
                Language.get("pasbar") +
                percent2 + "%");
        ...
        bar3.setString(carPark.getTotalReservationIndex() +  " " +
                Language.get("resbar") +
                percent3 + "%");
